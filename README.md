...
- **基础日历保持安静**：“中国日历”只包含班休、核心传统节日与二十四节气，并按假期范围去重。
...
| 频道 | 月视图内容 | 频率 | 订阅 |
| --- | --- | --- | --- |
| **中国日历** | 假期、调休、核心节日与节气 | 约每月 3 条 | [`essential.ics`](https://apple-calendar.lili.uno/essential.ics) |

### 可拆分的基础频道

希望分别设置颜色时，可改订阅下列拆分频道，不要与“中国日历”重复添加。
...
| **假期提醒** | 每个已确认法定假期开始前 7 天提示一次 | 每个假期 1 条 | [`holiday-reminders.ics`](https://apple-calendar.lili.uno/holiday-reminders.ics) |
| **生活节日** | 母亲节、父亲节、情人节、520、感恩节、圣诞节等 | 每年 9 条 | [`life-festivals.ics`](https://apple-calendar.lili.uno/life-festivals.ics) |
| **农历初一十五** | 每个农历月只保留初一和十五 | 每月 2 条 | [`lunar-days.ics`](https://apple-calendar.lili.uno/lunar-days.ics) |
...
“完整农历”和“逐日假期倒计时”在其他公开订阅源中较常见，但会分别产生每天一条、最长连续上百条全天事件。本项目改为“初一十五”和“提前 7 天一次”，保留实用性而不淹没月视图。
